...
// Per-donation certificate for donations completed through a Blood Bank's
// own stock-refill request (source: 'blood_bank' in Firestore — see
// BloodBankStockTab._acceptDonorOffer). Kept as its own certificate type
// (not reusing HospitalCertificateHelper) per Sowmi's request, so a donor's
// Blood Bank vs Hospital contributions stay visually distinct in their
// certificate list, even though the layout mirrors it closely.
class BloodBankCertificateHelper {
  static Future<void> generateAndShare({
    required String donorName,
    required String bloodGroup,
    required String bankOrLocation,
        ...
        child: pw.Center(
          child: pw.Column(
            ...
            children: [
              ...
              pw.Text(
                'For responding to a blood stock request and donating at\n'
                    '$bankOrLocation,\nhelping replenish life-saving supplies through BloodLink.',
    ...
    await Printing.sharePdf(
      ...
      filename: 'BloodLink_BloodBankCertificate_${donorName.replaceAll(' ', '_')}_${DateFormat('yyyyMMdd').format(date)}.pdf',
    );
  }
}