...
import '../hospital_edit_profile_screen.dart';
...
class HospitalProfileTab extends StatefulWidget {
  ...
  const HospitalProfileTab({super.key, required this.hospitalData, required this.primaryColor, required this.onDataUpdated});
  @override
...
class _HospitalProfileTabState extends State<HospitalProfileTab> with SingleTickerProviderStateMixin {
  ...
  Future<void> _editProfile() async {
    final updated = await Navigator.push<bool>(context, MaterialPageRoute(
        builder: (_) => HospitalEditProfileScreen(
            hospitalData: widget.hospitalData, primaryColor: widget.primaryColor)));
  ...
  Widget build(BuildContext context) {
    ...
    final name = data?['hospital_name'] ?? 'Hospital';
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              child: Column(children: [
                ...
                Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Text('Registered Hospital', style: TextStyle(color: Colors.white.withValues(alpha: 0.9), fontSize: 12)),
                    ])),
              ]),
            ),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const Text('Hospital Info', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF1A1A2E))),
                const SizedBox(height: 12),
                _buildInfoCard([
                  _Info(Icons.local_hospital_outlined, 'Hospital Name', name),
