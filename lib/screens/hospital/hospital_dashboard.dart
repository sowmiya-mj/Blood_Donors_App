...
import 'tabs/hospital_requests_tab.dart';
import 'tabs/hospital_search_tab.dart';
import 'tabs/hospital_profile_tab.dart';
...
class _HospitalDashboardState extends State<HospitalDashboard> with TickerProviderStateMixin {
  int _currentIndex = 0;
  ...
  final List<_NavItem> _navItems = [
    ...
    _NavItem(icon: Icons.bloodtype_rounded, label: 'Requests'),
  ...
  Future<void> _fetchHospitalData() async {
    try {
      ...
      if (doc.exists) setState(() { _hospitalData = doc.data(); _isLoading = false; });
