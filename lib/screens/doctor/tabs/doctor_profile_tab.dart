          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                TweenAnimationBuilder<double>(
                  ...
                  child: Stack(alignment: Alignment.bottomRight, children: [
                    ...
                    Container(
                      ...
                      child: Icon(Icons.medical_services_rounded, color: color, size: 16),
                    ),
                  ]),
                ),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 12),
                _buildInfoCard([
                  _InfoItem(Icons.medical_information_outlined, 'Specialization', specialization),
                  _InfoItem(Icons.local_hospital_outlined, 'Hospital / Clinic', affiliation),
                  _InfoItem(Icons.badge_outlined, 'Medical License No.', license),
